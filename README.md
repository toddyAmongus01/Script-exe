...
local Window = OrionLib:MakeWindow({Name = "Toddy Hub Exe (Beta), HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Toddy Hub Exe (Beta)"})

OrionLib:MakeNotification({
	Name = "Toddy Hub Exe (Beta),
...
W:AddLabel("[+] Toddy Hub Exe (Beta) is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Toddy Hub Exe (Beta)(Noitification)",
